...
ACTION_SPECS: list[dict[str, Any]] = [
    ...
    {
        "name": "send_mail",
        "description": "Send an email message through the granted mail bridge headlessly.",
        "payload": {
            "type": "object",
            "additionalProperties": False,
            "properties": {
        ...
        "target_ownership": "owner",
        "provider": "mail",
        "evidence": ["source", "timestamp", "sent"],
        "idempotency": "key",
        "cancellation": "timeout",
        "required_scopes": ["mail:act"],
    },
    {
        "name": "save_contact",
        "description": "Create or update a contact record in the owner's contacts headlessly.",
        "payload": {
            "type": "object",
            "additionalProperties": False,
            "properties": {
        ...
        "requires_approval": False,
        "undoable": True,
        "permission": "contacts:act",
        "read_only": False,
        "risk_class": "R2",
        "confirmation": "policy",
        "target_ownership": "owner",
        "provider": "contacts",
        "evidence": ["source", "timestamp", "created"],
        "idempotency": "key",
        "cancellation": "not_applicable",
        "required_scopes": ["contacts:act"],
    },
    {
        "name": "update_contact",
        "description": "Update an existing contact record in the owner's contacts headlessly.",
        "payload": {
            "type": "object",
            "additionalProperties": False,
            "properties": {
        ...
        "target_ownership": "owner",
        "provider": "contacts",
        "evidence": ["source", "timestamp", "updated"],
        "idempotency": "key",
        "cancellation": "not_applicable",
        "required_scopes": ["contacts:act"],
    },
